                ...
                >
                    {props => (
                        <View style={styles.form}>
                            ...
                            <CustomButton title='Submit' style={{width: 140,backgroundColor:'#07085B',marginLeft:'22%', marginBottom:40}} nameIcon='check' sizeIcon={20} onPress={props.handleSubmit}></CustomButton>
