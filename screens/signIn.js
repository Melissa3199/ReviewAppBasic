                ...
                >
                    {props => (
                        <View style={styles.form}>
                            ...
                            <CustomButton title='Go ' style={{width: 100,backgroundColor:'#07085B',marginLeft:'30%', marginBottom:40 }} nameIcon='arrow-right' sizeIcon={20} onPress={props.handleSubmit}></CustomButton>
