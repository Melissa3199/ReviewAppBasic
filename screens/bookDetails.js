...
export default function ({ navigation }) {
    ...
    const rating = navigation.getParam('averageRating');

    const [modalOpen, setModalOpen] = useState(false);

    const thumbNail= navigation.getParam('imageLinks').thumbnail; 
    const Image_URL ={ uri: thumbNail};
   ...
   // console.log(navigation.getParam('imageLinks').thumbnail);
  //  console.log(navigation.getParam('title'));
    return (
        <ScrollView>
            ...
            <ImageBackground style={styles.backImage} blurRadius={3} source={Image_URL}>
                <Image style={styles.frontImage} source={Image_URL} />
            </ImageBackground>

            <View>
                <Text style={styles.titleStyle}>{navigation.getParam('title')}</Text>
                <Text style={styles.textStyle}>{navigation.getParam('authors')}</Text>
            </View>
            ...
            <View style={styles.description}>
                ...
                <Text style={[styles.textStyle, { fontFamily: 'Montserrat-Italic' }]}>{navigation.getParam('description')}</Text>
            </View>
